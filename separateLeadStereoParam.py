...
def main(inputAudioFile,song_name,to_email_id):
    ...
    outputFileName = os.path.join(BASE_DIR, 'Project/media/vocals/' + inputAudioFile)
    ...
    outputFileName = os.path.join(BASE_DIR,'Project/media/karaoke/' + inputAudioFile)
    ...
    wav.write(outputFileName, fs, \
              np.array([mestR,mestL]).T)
    ###########################################
    ##NOT REQUIRED# DATABASE UPDATE HERE#####################
